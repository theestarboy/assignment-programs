...
void myfunction(int units, float *chargePerUnit, float *totalBill) {
...
int main() {
    ...
    float surcharge = 0.0, totalBill = 0.0, chargePerUnit = 0.0;
    ...
    myfunction(units, &chargePerUnit, &totalBill); 
